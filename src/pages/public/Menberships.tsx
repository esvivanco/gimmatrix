...
export const Menbership = ({ title, price, details, selected }: MenbershipProps) => {
    ...
    return (
        <article style={{ width: "100%", height: "550px", background: "transparent", position: "relative", transition: "all 0.3s", borderTopLeftRadius: "0px", borderTopRightRadius: "0px", borderBottomRightRadius: "20px", borderBottomLeftRadius: "20px",border: selected ? "solid 3px black" : "solid 3px rgb(0,0,0,0.2)", transform: "scale("+ scale+")"}} onMouseOver={() => {setScale(1.08)}} onMouseOut={() => {setScale(1)}}>
            ...
            <h1 style={{ marginTop: "30px", marginLeft: "20px", color: "rgb(0, 0, 0)", fontWeight: "900", fontSize: "32px" }}>{title.toUpperCase()} - <label style={{color: "rgb(0, 0, 0)", fontWeight: "300", fontSize: "32px" }}>GYM MATRIX</label><i style={{marginLeft: "5px", marginTop: "5px"}} className="bi bi-tags-fill"></i></h1>
            ...
            <Button sx={{ position: "absolute", fontFamily: "kanit", left: "110px", bottom: "70px", width: "calc(100% - 220px)", background: "black", color: "white", border: "none", textTransform: "none", fontSize: "22px", fontWeight: "800", height: "50px", borderRadius: "25px" }}>
                SUSCRIBIRSE
            </Button>
