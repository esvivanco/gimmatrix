    ...
    return (
        <div>
            ...
            <div style={{ position: "absolute", zIndex: "5", top: "0px", background: "rgb(255,230,0)", height: "calc(100% + 200px)", left: "0px", visibility: visibility ? "visible" : "hidden", width: "100%", display: visibility ? "block" : "none" }}>
                <button style={{position: "absolute", marginTop: "20px", left: "50%", transform: "translateX(-50%)", background: "none", border: "none", color: "black", fontSize: "32px"}} onClick={() => { setVisibility(false) }}> <i className="bi bi-x-circle"></i> </button>
                <div style={{ paddingTop: "70px", paddingBottom: "100px", background: "rgb(255,230,0)" }}>
                    <Container margin={20}>
                        <Notfound>
